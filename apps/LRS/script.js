...
function onRoadClick(e, roadFeature, roadLayer) {
    ...
    addLabelsToPR([closest1, closest2]);
    highlightRoadSection(roadLayer, clickLatLng, [closest1.layer.getLatLng(), closest2.layer.getLatLng()]);
}
...
function addLabelsToPR(prPoints) {
    prPoints.forEach(pr => {
