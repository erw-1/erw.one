...
// LocalStorage cache helpers (try/catch guarded)
...
// Exported so other modules can reuse the same wiring
export const HEADINGS_SEL = 'h1, h2, h3, h4, h5, h6';

// Public namespace (global KM)
window.KM = window.KM || {};
const KM = window.KM;
...
/** Update viewport variables (called on resize) */
...
export const ICONS_PUBLIC = ICONS; // icon paths
