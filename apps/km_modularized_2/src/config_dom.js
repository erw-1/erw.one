...
// Basic DOM utilities and configuration
...
/** Create an element with given props and children. */
...
// Expose a couple of helpers and a DEBUG flag globally
window.KM = window.KM || {};
Object.assign(window.KM, { $, $$, DEBUG: false });
...
// Viewport dimensions (updated on resize by app)
...
/** Copy text to clipboard with a small flash on a given node. */
...
// SVG icon paths
const ICONS = {
  link: 'M3.9 12c0-1.7 1.4-3.1 3.1-3.1h5.4v-2H7c-2.8 0-5 2.2-5 5s2.2 5 5 ' +
        '5h5.4v-2H7c-1.7 0-3.1-1.4-3.1-3.1zm5.4 1h6.4v-2H9.3v2zm9.7-8h-5.4v2H19c1.7 ' +
        '0 3.1 1.4 3.1 3.1s-1.4 3.1-3.1 3.1h-5.4v2H19c2.8 0 5-2.2 5-5s-2.2-5-5-5z',
  code: 'M19,21H5c-1.1,0-2-0.9-2-2V7h2v12h14V21z M21,3H9C7.9,3,7,3.9,7,5v12 ' +
        'c0,1.1,0.9,2,2,2h12c2.2,0,2-2,2-2V5C23,3.9,22.1,3,21,3z M21,17H9V5h12V17z',
};

/** Create an SVG icon button. */
